...
int buffer[], int flags,char flag_ch, int width, int precision, int size);
...
int write_num(int ind, char buff[],
	char bff[], int width, int precision, int length, char padd, char extra_c);
int write_pointer(char buffer[], int ind, int length,
	int width, int flags, char padd, int extra_c, int padd_start);
